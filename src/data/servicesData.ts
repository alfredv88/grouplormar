export const serviceImages = {
  construccion: [
    '/images/services/construccion_real.webp',
    '/images/services/construccion_desarrollo.webp',
    '/images/services/construccion_electricas.webp',
    '/images/services/construccion_facilidades.webp',
  ],
  mantenimiento: [
    '/images/services/mantenimiento_real.webp',
    '/images/services/mantenimiento_integridad.webp',
    '/images/services/mantenimiento_correctivo.webp',
    '/images/services/mantenimiento_flota.webp',
  ],
  pozos: [
    '/images/services/pozos_real.webp',
    '/images/equipment/pulling_unit.webp',
    '/images/equipment/planta_electrica.webp',
  ],
  ambiental: [
    '/images/services/ambiental_real.webp',
    '/images/services/ambiental_remediacion.webp',
    '/images/services/ambiental_gestion.webp',
  ],
  logistica: [
    '/images/services/logistica_real.webp',
    '/images/services/logistica_transporte.webp',
    '/images/services/logistica_flota.webp',
    '/images/equipment/grua-120t.webp',
    '/images/equipment/manlift.webp',
  ],
};
