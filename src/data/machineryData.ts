...
export const machineryCategories: MachineryCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Cargadores Frontales y Minishowers', image: '/images/equipment/pala_mecanica.webp' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Tráilers y Oficinas Móviles', image: '/images/services/logistica_izamiento.webp' },
