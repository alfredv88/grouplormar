...
export const machineryCategories: MachineryCategory[] = [
  {
    ...
    items: [
      ...
      { name: 'Brazos Hidráulicos (6, 15, 20 y 25 Ton)', image: '/images/equipment/brazo-hidraulico.png' },
      { name: 'Montacargas pesados (6 a 25 Ton)', image: '/images/equipment/montacargas-v1.webp' },
      { name: 'Manlift y Camión Cesta', image: '/images/equipment/manlift.png' },
    ],
    bg: 'gold',
  ...
  },
  {
    ...
    items: [
      { name: 'Tractores y Mototraíllas', image: '/images/equipment/tractor-mototrailla.jpeg' },
      ...
      { name: 'Excavadoras con Martillo', image: '/images/equipment/excavadora_martillo.png' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Chutos con Batea y Volqueta', image: '/images/equipment/chuto_batea.png' },
      { name: 'Vacuum de 160 BLS y Supervactor', image: '/images/equipment/vacuum_truck_ia.png' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Camión Hot Oil', image: '/images/equipment/camion_hot_oil_ia.png' },
      { name: 'Equipos Flush-By', image: '/images/equipment/flush_by_ia.png' },
      { name: 'Camión Hidrojet Industrial', image: '/images/equipment/camion_hidrojet.png' },
    ],
    bg: 'dark',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Camión Rosco y Barredoras Autopropulsadas', image: '/images/equipment/camion_rosco_ia.png' },
  ...
  },
  {
    ...
    columns: 2,
    items: [
      { name: 'Plantas Eléctricas', image: '/images/equipment/planta_electrica.png' },
      { name: 'Compresores de Aire', image: '/images/equipment/compresor_aire_ia.png' },
      { name: 'Torres de Iluminación', image: machineryImages.menores },
      { name: 'Máquinas de Soldar', image: '/images/equipment/maquina_soldar_ia.png' },
      { name: 'Motobombas (6" x 6" de 80HP)', image: '/images/equipment/motobomba_ia.png' },
      { name: 'Tráilers y Oficinas Móviles', image: '/images/services/logistica_izamiento.jpg' },
      { name: 'Baños Portátiles y Lavamanos', image: '/images/equipment/banos_portatiles_ia.png' },
    ],
    bg: 'dark',
