      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-16 border-b border-7l-gold/20 pb-10">
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-7l-gold">
              ...
              <span className="font-syncopate text-[10px] font-bold tracking-[0.4em] uppercase">
                SISTEMA DE MONITOREO DE ACTIVOS
              </span>
            </div>
            <h2 className="text-4xl md:text-5xl font-future text-white uppercase leading-none">
          ...
          {monitors.map((mon, idx) => (
            ...
            >
              ...
              <div className="absolute top-4 left-4 z-20 flex items-center gap-2">
                ...
                <span className="font-syncopate text-[8px] text-white/60 tracking-tighter">
                  CAM_{mon.id} // SECURE_LINK
                </span>
              </div>

              <div className="absolute bottom-4 right-4 z-20">
                <span className="font-syncopate text-[8px] text-7l-gold px-2 py-1 border border-7l-gold/30 bg-7l-black/80">
                  STATUS: {mon.status}
                </span>
              </div>
              ...
              <div className="mt-4 flex justify-between items-center px-2 pb-2">
                <h4 className="font-syncopate text-[10px] text-white font-bold tracking-widest">{mon.label}</h4>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 pt-10 border-t border-white/5">
           <div className="space-y-2">
             <span className="text-[10px] font-syncopate text-7l-gray block">UBICACIÓN</span>
             <p className="text-white font-syne font-bold text-sm">PATIO CENTRAL - ANZOÁTEGUI</p>
           </div>
           <div className="space-y-2">
             <span className="text-[10px] font-syncopate text-7l-gray block">DISPONIBILIDAD</span>
             <p className="text-7l-gold font-syne font-bold text-sm">IMMEDIATE DEPLOYMENT</p>
           </div>
           <div className="space-y-2">
             <span className="text-[10px] font-syncopate text-7l-gray block">CERTIFICACIÓN</span>
             <p className="text-white font-syne font-bold text-sm">ISO 9001 / OSHAS 18001</p>
           </div>
