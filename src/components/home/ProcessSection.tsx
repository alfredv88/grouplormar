...
export default function ProcessSection() {
  ...
  return (
    <section className="relative py-20 px-6 overflow-hidden bg-white border-y border-gray-100" id="proceso">
        ...
        <div className="grid md:grid-cols-4 gap-4 md:gap-0">
          {steps.map((step, idx) => (
            <motion.div
              ...
              className="group relative py-7 px-10 border-l border-gray-100 hover:bg-gray-50/50 transition-all duration-300 cursor-default"
            >
              ...
              <span className="text-6xl font-montserrat font-black leading-none block mb-5 transition-colors duration-500 text-7l-gold/40 group-hover:text-7l-gold">
                {step.num}
              </span>
