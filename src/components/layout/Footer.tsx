             ...
             <div className="pt-10 border-t border-white/10 space-y-4">
                <div className="flex flex-col gap-4">
                   <div className="flex items-center gap-4 text-gray-200">
                      ...
                      <span className="text-[10px] font-montserrat tracking-widest"><span className="text-gray-400 text-[8px] mr-2 text-nowrap">NAPOLEÓN B.</span> +58 414 181 61 62</span>
                   </div>
                   <div className="flex items-center gap-4 text-gray-200">
                      <Phone size={14} className="text-7l-gold" />
                      <span className="text-[10px] font-montserrat tracking-widest"><span className="text-gray-400 text-[8px] mr-2 text-nowrap">BRAYHAN B.</span> +58 412 944 86 72</span>
                   </div>
                </div>
