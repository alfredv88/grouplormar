...
- **Tipografías:** Montserrat (cuerpo) y Orbitron (para titulares).
...
- Rediseño del Widget de Contacto: Cambio de iconos genéricos (bot/mensajes) por iconos industriales (`Construction`, `Headphones`) y adaptación del componente a esquema de color corporativo perimetral (#F2A900), con animaciones de "pulso" vital y bordes dinámicos.
